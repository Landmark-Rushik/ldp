...
class location_mapping extends StatefulWidget {
  const location_mapping({Key? key}) : super(key: key);

  @override
  State<location_mapping> createState() => _location_mappingState();
}

class _location_mappingState extends State<location_mapping> {
  var location_mapping_fileName = "";

  List<List<dynamic>> location_mapping_data = [];
          ...
          Padding(
            ...
            child: Column(
              children: [
                        ...
                        child: Material(
                          ...
                          child: MaterialButton(
                            ...
                            child: new Text("Choose File",
                                // '   Please select Location Mapping file for ' +
                                //     str_pera_is_app_ovr +
                                //     '...   ',
                                style: new TextStyle(
                            ...
                            onPressed: () async {
                              ...
                              if (result!.files.first != null) {
                                ...
                                location_mapping_data = csvTable;
                        ...
                        children: [
                          ...
                          is_dow_Upl
                              ? is_File_selected
                                  ? Flexible(
                                      child: Text(
                                        "You can Upload Location Mapping (" +
                                            location_mapping_fileName +
                                            ") using mode : " +
                                            str_pera_is_app_ovr,
                                        textAlign: TextAlign.center,
                                  ...
                                  : Flexible(
                                      child: Text(
                                        "You can Upload Location Mapping after select file...",
                                        textAlign: TextAlign.center,
                                        maxLines: 2,
                                        style: new TextStyle(
                                          fontSize: Main_font,
                              ...
                              : is_data_download
                                  ? Flexible(
                                      child: Text(
                                        "You can Download Location Mapping",
                                        textAlign: TextAlign.center,
                                        maxLines: 2,
                                        style: new TextStyle(
                                          fontSize: Main_font,
                                  ...
                                  : Flexible(
                                      child: Text(
                                        "You can Download Location Mapping after load data...",
                                        textAlign: TextAlign.center,
                                        maxLines: 2,
                                        style: new TextStyle(
                                          fontSize: Main_font,
                ...
                //             style: BorderStyle.solid,
                //           ),
                //           children: location_mapping_data.map((item) {
                //             return TableRow(
                ...
                //     //     child: ListView.builder(
                //     //         // padding: const EdgeInsets.all(8),
                //     //         itemCount: location_mapping_data.length - 1,
                //     //         itemBuilder: (BuildContext context, int index) {
                //     //           return Padding(
                //     //             padding: const EdgeInsets.all(3),
                //     //             child: Container(
                ...
                //     //                     children: [
                //     //                       Text(
                //     //                         location_mapping_data[index + 1][0],
                //     //                         style: new TextStyle(
                //     //                           fontSize: Main_font,
                //     //                           color:
                ...
                //     //                       ),
                //     //                       Text(
                //     //                         location_mapping_data[index + 1][1],
                //     //                         style: new TextStyle(
                //     //                           fontSize: Main_font,
                //     //                           color:
                //     //                               Color.fromARGB(255, 0, 0, 0),
                ...
                //     //                       // Spacer(),
                //     //                       Text(
                //     //                         location_mapping_data[index + 1][2],
                //     //                         style: new TextStyle(
                //     //                           fontSize: Main_font,
                //     //                           color:
                //     //                               Color.fromARGB(255, 0, 0, 0),
                ...
                //     //                       // Spacer(),
                //     //                       Text(
                //     //                         location_mapping_data[index + 1][3],
                //     //                         style: new TextStyle(
                //     //                           fontSize: Main_font,
                //     //                           color:
                //     //                               Color.fromARGB(255, 0, 0, 0),
  ...
  File_Upload_calling() async {
    if (is_File_selected) {
      ...
      AwesomeDialog(
              ...
              dialogType: DialogType.WARNING,
              animType: AnimType.TOPSLIDE,
              title: 'Please select Location Mapping for ' +
                  str_pera_is_app_ovr +
                  '.',
              desc: '',
              btnOkColor: Theme.of(context).primaryColor,
  ...
  File_Upload_call() async {
    // /api/v1/mercedes-benz/service/invoice_number_prefix_to_location_mapping
    var postUri = Uri.parse(globals.str_URL +
        "api/v1/mercedes-benz/service/invoice_number_prefix_to_location_mapping?write_mode=" +
        str_pera_is_app_ovr);
    var request = http.MultipartRequest("POST", postUri);
    request.files.add(http.MultipartFile.fromBytes('file', fileBytes,
        filename: location_mapping_fileName,
        ...
        setState(() {
          ...
          if (chk_Statuscode == "4") {
            AwesomeDialog(
                ...
                dialogType: DialogType.ERROR,
                animType: AnimType.TOPSLIDE,
                title: "File Not Uploaded Successfully",
                desc: map_Response["msg"] + '\n\n Please try again.',
                btnOkColor: Theme.of(context).primaryColor,
                // btnCancelOnPress: () {},
                btnOkOnPress: () {
  ...
  Data_View_call() async {
    ...
    //     globals.str_URL+"api/v1/mercedes-benz/service/invoice_number_prefix_to_location_mapping");
    ...
    // /api/v1/mercedes-benz/service/invoice_number_prefix_to_location_mapping
    // var postUri = Uri.parse(
    //     globals.str_URL+"api/v1/mercedes-benz/service/vehicle_models");
    var postUri = Uri.parse(globals.str_URL +
        "api/v1/mercedes-benz/service/invoice_number_prefix_to_location_mapping");
    var request = http.MultipartRequest("GET", postUri);
    // request.files.add(http.MultipartFile.fromBytes('file', fileBytes,
