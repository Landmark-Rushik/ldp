...
class _wcState extends State<wc> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  //     onChanged: (newVal) {
                  //       if (newVal == "Gujarat") {
                  //         str_Selected_resion = "gj";
                  //       } else if (newVal == "Madhya Pradesh") {
                  //         str_Selected_resion = "mp";
                  //       } else if (newVal == "Mumbai") {
                  //         str_Selected_resion = "bom";
                  //       } else if (newVal == "Kolkata") {
                  //         str_Selected_resion = "ccu";
                  //       } else if (newVal == "All Locations") {
                  //         str_Selected_resion = "all_regions";
                  //       } else {
                  //         str_Selected_resion = "";
                  //       }

                  //       setState(() {
                  //         _selectResion = newVal!;
                  //       });
                  //     },
                  //     items: <String>[
                  //       'Gujarat',
                  ...
                  Padding(
                    ...
                    child: Material(
                      ...
                      child: MaterialButton(
                        ...
                        color: Color.fromARGB(255, 0, 0, 0),
                        child:
                            new Text('     Please select your data file     ',
                                style: new TextStyle(
                                  fontSize: Main_font,
                                  color: Colors.white,
                  ...
                  is_File_selected
                      ? Text(
                          "Your Selected file for warranty claim is : " +
                              Selected_from_date +
                              "_" +
                              Selected_to_date +
                              "_" +
  ...
  File_Upload_call() async {
    ...
    var postUri = Uri.parse(
        globals.str_URL + "api/v1/mercedes-benz/service/warranty_claims");
